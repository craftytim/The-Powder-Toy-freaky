...
constexpr float MAX_TEMP = 100000000000.0f;
constexpr float MIN_TEMP = -100000000000.0f;
constexpr float O_MAX_TEMP = 3500;
constexpr float O_MIN_TEMP = -273.0f;

constexpr float MAX_PRESSURE = 25600.0f;
constexpr float MIN_PRESSURE = -25600.0f;
